...
export const projects: Project[] = [
  {
    ...
    images: ['/assets/images/Proyectos/Aquanova/Portada.jpeg',
      '/assets/images/Proyectos/Aquanova/Pagina principal.JPG',
      '/assets/images/Proyectos/Aquanova/KitDomotizacion.JPG',
      '/assets/images/Proyectos/Aquanova/Catalogo.JPG',
      '/assets/images/Proyectos/Aquanova/ModalPileta.JPG',
    ],
  },
  {
    slug: 'campuscore',
    ...
    images: ['/assets/images/Proyectos/CampuScore/Portada.png',
      '/assets/images/Proyectos/CampuScore/Principal.JPG',
      '/assets/images/Proyectos/CampuScore/Universidad.JPG',
      '/assets/images/Proyectos/CampuScore/BrainHunter.JPG',
      '/assets/images/Proyectos/CampuScore/Alumno.JPG',
      '/assets/images/Proyectos/CampuScore/Alumno2.JPG',
      '/assets/images/Proyectos/CampuScore/Alumno3.JPG',
      '/assets/images/Proyectos/CampuScore/Medallas.JPG',
    ],
  },
  {
    slug: 'chatbot',
  ...
  },
  {
    ...
    download: '/assets/ejecutables/IPVision/Programa/IPVision.exe',
    images: [
      ...
      '/assets/images/Proyectos/IPVision/netstat.JPG',
      '/assets/images/Proyectos/IPVision/csv.JPG',
    ],
  },
  {
    slug: 'knowbeat',
    ...
    images: ['/assets/images/Proyectos/KnowBeat/Portada.png',
      '/assets/images/Proyectos/KnowBeat/Comunidad.JPG',
      '/assets/images/Proyectos/KnowBeat/Aprender.JPG',
      '/assets/images/Proyectos/KnowBeat/Ejercicios.JPG',
      '/assets/images/Proyectos/KnowBeat/Carpetas.JPG',
      '/assets/images/Proyectos/KnowBeat/Chats.JPG',
      '/assets/images/Proyectos/KnowBeat/Perfil.JPG'  ,
    ],
  },
  {
    slug: 'nextread',
    ...
    duration: 'Julio - Noviembre (2025)',
    github: 'https://github.com/AlejoGuerraa/nextRead',
    images: ['/assets/images/Proyectos/NextRead/Portada.png',
      '/assets/images/Proyectos/NextRead/Landing.png',
      '/assets/images/Proyectos/NextRead/Principal.png',
      '/assets/images/Proyectos/NextRead/Perfil.png',
      '/assets/images/Proyectos/NextRead/Libro.png',
      '/assets/images/Proyectos/NextRead/Registro.png'
    ],
  },
  {
    slug: 'tubuffet',
    ...
    images: ['/assets/images/Proyectos/TuBuffet/Portada.png',
      '/assets/images/Proyectos/TuBuffet/Menu.JPG',
      '/assets/images/Proyectos/TuBuffet/Inventario.JPG',
      '/assets/images/Proyectos/TuBuffet/Ventas.JPG', 
      '/assets/images/Proyectos/TuBuffet/Pedidos.JPG',
      '/assets/images/Proyectos/TuBuffet/Validar.JPG',
    ],
  },
]
